...
ucllm_nedo_dev_train_dir="${HOME}/ucllm_nedo_prod_kawagoshi/train"
...
data_path="/home/ubuntu/ucllm_nedo_prod_kawagoshi/data_management/output/filterd_documents/results.filtering.jsonl"
