...
def download_dataset(output_base: str = "output", index_from: int = 0, index_to: int = 0) -> None:
    ...
    output_path = os.path.join(output_base, "datasets/togethercomputer/refineweb")
    dataset_root = os.path.join(output_base, "tmp/togethercomputer/refineweb")
    ...
    filebase = "train-{index}-of-05534-b8fc5348cbe605a5.parquet"
    ...
    for i in range(index_from, index_to + 1):
        filename = filebase.format(index=str(i).zfill(5))
