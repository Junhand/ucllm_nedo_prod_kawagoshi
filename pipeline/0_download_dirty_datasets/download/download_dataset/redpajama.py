...
ROOT_PATH = pathlib.Path(download.__path__[0]).resolve().parent
...
def download_dataset(split: str = "", output_base: str = "tmp/output") -> None:
    ...
    dataset_root = os.path.join(output_base, "tmp/redpajama")
    ...
    output_path = os.path.join(output_base, "redpajama")
