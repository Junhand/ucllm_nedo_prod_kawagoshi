...
def main():
    ...
    parser.add_argument('--input_dir', type=str,
                        help='The input directory containing documents to process', required=False, default="~/ucllm_nedo_prod_kawagoshi/pipeline/3_download_and_merge_datasets/output")
